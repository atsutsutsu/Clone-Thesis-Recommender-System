...
export default function Entrance_Exam() {
    ...
    const text = (
        <div style={{ width: "100%", display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <p className="titlepertable">Entrance Exam</p>
            <Link to="Add" style={{ textDecoration: "none" }}><button className="button_add"><AddIcon sx={{ fontSize: "22px" }} />Add Exam</button></Link>
        </div>
    )
    const column1 = [
        { id: 'No of Item', label: 'CID', align: 'center', minWidth: 50 },
        { id: 'FIELD', label: 'Field', minWidth: 100 },
    ]

    const column2 = [
        { id: 'EEID', label: 'EEID', align: 'center', minWidth: 50 },
        { id: 'TITLE', label: 'Title', minWidth: 100 },
        { id: 'MATH_TOTAL_ITEM', label: 'Math', minWidth: 100 },
        { id: 'ENGLISH_TOTAL_ITEM', label: 'English' },
        { id: 'SCIENCE_TOTAL_ITEM', label: 'Science', align: 'center' },
        { id: 'READING_COMPREHENSION_TOTAL_ITEM', label: 'Reading Comprehension', align: 'center' },
        { id: 'TOTAL_ITEM', label: 'Total Items', align: 'center' },
    ...
    function locationget() {
        ...
        if (parts === "Delete" || parts === "cscsac" || parts === "Edit") {
            setcontent(false)
        } else {
            setcontent(true)
        }
